...
function cacheFunction(cb) {
  let obj={};
  return function(arg){
    if(obj.hasOwnProperty(arg)){    //creo un objeto vacio, luego pregunto si ese objeto está dentro del objeto, si no está creo creo una variable que guarde el cb con el argumento pedido, luego decimos que eso será igual al valor del argumento pasado para que se guarde.
      return obj[arg];
    }
    else{
      obj[arg]=cb(arg);
